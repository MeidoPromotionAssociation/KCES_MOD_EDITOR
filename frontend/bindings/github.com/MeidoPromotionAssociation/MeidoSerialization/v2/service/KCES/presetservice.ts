...
export function ConvertJsonToPreset(inputPath: string, outputPath: string, maxOutputBytes: number): $CancellablePromise<void> {
    return $Call.ByID(550342606, inputPath, outputPath, maxOutputBytes);
}
...
export function ConvertPresetToJson(inputPath: string, outputPath: string, maxOutputBytes: number): $CancellablePromise<void> {
    return $Call.ByID(3880377386, inputPath, outputPath, maxOutputBytes);
}
...
export function ReadPresetFile(path: string): $CancellablePromise<KCES$0.ExpandedKCESPreset | null> {
    return $Call.ByID(550069290, path).then(($result: any) => {
...
export function WritePresetFile(path: string, value: KCES$0.ExpandedKCESPreset | null): $CancellablePromise<void> {
    return $Call.ByID(2359862871, path, value);
}
