...
export function ConvertGLTFToModel(inputPath: string, outputDir: string, maxOutputBytes: number): $CancellablePromise<void> {
    return $Call.ByID(3222547343, inputPath, outputDir, maxOutputBytes);
}
...
export function ConvertJsonToModel(inputPath: string, outputPath: string, maxOutputBytes: number): $CancellablePromise<void> {
    return $Call.ByID(388124894, inputPath, outputPath, maxOutputBytes);
}
...
export function ConvertModelToGLTF(inputPath: string, outputPath: string, format: string, maxOutputBytes: number): $CancellablePromise<void> {
    return $Call.ByID(1523017743, inputPath, outputPath, format, maxOutputBytes);
}
...
export function ConvertModelToJson(inputPath: string, outputPath: string, maxOutputBytes: number): $CancellablePromise<void> {
    return $Call.ByID(432401000, inputPath, outputPath, maxOutputBytes);
}
...
export function ReadModelFile(path: string): $CancellablePromise<KCES$0.Model | null> {
    return $Call.ByID(3559984538, path).then(($result: any) => {
...
export function WriteModelFile(path: string, value: KCES$0.Model | null): $CancellablePromise<void> {
    return $Call.ByID(907256693, path, value);
}
